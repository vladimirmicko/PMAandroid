...
public class LoginActivity extends AppCompatActivity {
    ...
    public class LoginService extends AsyncTask<String, Integer, String> implements TaskListener {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                responseEntity = restTemplate.exchange(MyApplication.getAppContext().getResources().getString(R.string.url_base)+MyApplication.getAppContext().getResources().getString(R.string.url_authenticate), HttpMethod.POST, requestEntity, UserAccount.class);
